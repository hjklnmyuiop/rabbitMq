        ...
        try {
            ...
            finalChannel.basicConsume(queueName, true, new DeliverCallback() {
                ...
                public void handle(String s, Delivery delivery) throws IOException {
                    ...
                    System.out.println(queueName + Thread.currentThread().getName()+"：收到消息是：" + new String(delivery.getBody(), "UTF-8"));
                }
            }, new CancelCallback() {
                @Override
...
//            // 7: 释放连接关闭通道
    ...
    public static void main(String[] args) throws Exception {
        // 启动三个线程去执行
        new Thread(runnable, "direct5").start();
        new Thread(runnable, "direct5").start();
    }
}
